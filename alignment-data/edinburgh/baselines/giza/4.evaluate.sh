...
java -DJACANA_HOME=/Users/chetannaik/s/3/jacana -cp /Users/chetannaik/s/3/jacana/build/lib/jacana-align.jar edu.jhu.jacana.align.evaluation.AlignEvaluator /Users/chetannaik/s/3/jacana/alignment-data/edinburgh/gold.test.sure.json edinburgh.align.giza.$RULE.json
